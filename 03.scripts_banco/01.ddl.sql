...
DROP TABLE TB_AUX_AGENDAMENTO
DROP TABLE TB_AUX_CLIENTE
DROP TABLE TB_AUX_FUNCIONARIO
DROP TABLE TB_AUX_SALAO
DROP TABLE TB_AUX_SERVICO
DROP TABLE TB_AUX_TIPO_SERVICO

DROP TABLE FATO_AGENDAMENTO
DROP TABLE FATO_SERVICO
DROP TABLE FATO_PAGAMENTOS_MENSAL
DROP TABLE DIM_CLIENTE
DROP TABLE DIM_FAIXA_ETARIA
DROP TABLE DIM_FUNCIONARIO
DROP TABLE DIM_STATUS
DROP TABLE DIM_TIPO_SERVICO
DROP TABLE DIM_SALAO
DROP TABLE DIM_TEMPO

DROP TABLE TB_VIO_AGENDAMENTO
DROP TABLE TB_VIO_SERVICO
...
CREATE TABLE TB_AGENDAMENTO (
    ...
    STATUS VARCHAR(11) NOT NULL CHECK(STATUS IN('AGENDADO', 'CONCLUIDO', 'CANCELADO')),
...
CREATE TABLE TB_PRODUTO_SERVICO (
	...
	PRIMARY KEY(COD_PRODUTO, ID_SERVICO)
)
...
FOREIGN KEY (COD_PRODUTO) REFERENCES TB_PRODUTO(CODIGO);
...
CREATE TABLE DIM_STATUS(
	...
	STATUS VARCHAR(100) NOT NULL CHECK (STATUS IN ('AGENDADO', 'CANCELADO','CONCLUIDO')),
)
