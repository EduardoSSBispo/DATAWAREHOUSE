...
---- POPULAR SALÃO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_SALAO (@NOME VARCHAR(45), @CNPJ VARCHAR(15), @RUA VARCHAR(45), @CIDADE VARCHAR(45), @UF VARCHAR(2), @NUMERO INT OUTPUT)
AS
BEGIN
...
---- POPULAR AGENDAMENTO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_AGENDAMENTO (@DT_AGENDAMENTO DATETIME, @HORARIO DATETIME, @STATUS VARCHAR(11), @VALTOTAL NUMERIC(10,2), @ID_SALAO INT, @ID_CLIENTE INT OUTPUT)
AS
BEGIN
	
	INSERT INTO TB_AGENDAMENTO
	VALUES(@DT_AGENDAMENTO, @HORARIO, @STATUS, @VALTOTAL, @ID_SALAO, @ID_CLIENTE)
END


---- POPULAR CLIENTE ----
CREATE OR ALTER PROCEDURE SP_POPULAR_CLIENTE (@NOME VARCHAR(45), @CPF VARCHAR(45), @EMAIL VARCHAR(50), @DT_NASCIMENTO DATETIME, @TELEFONE VARCHAR(45), @SEXO VARCHAR(15), @RUA VARCHAR(45), @CIDADE VARCHAR(45), @NUMERO INT OUTPUT)
AS
BEGIN
...
---- POPULAR FUNCIONARIO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_FUNCIONARIO (@NOME VARCHAR(45), @CPF VARCHAR(45), @EMAIL VARCHAR(50), @TELEFONE VARCHAR(20), @DT_NASCIMENTO DATETIME, @SALARIO NUMERIC(10,2), @CONTRATO DATETIME, @RUA VARCHAR(45), @CIDADE VARCHAR(45), @BAIRRO VARCHAR(45), @ID_SALAO INT OUTPUT)
AS
BEGIN
	INSERT INTO TB_FUNCIONARIO
	VALUES(@NOME, @CPF, @EMAIL, @TELEFONE, @DT_NASCIMENTO, @SALARIO, @CONTRATO, NULL, @CIDADE, @RUA, @BAIRRO, @ID_SALAO)
END


---- POPULAR SERVICO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_SERVICO (@ID_TIPOSERVICO INT, @ID_FUNCIONARIO INT, @ID_AGENDAMENTO INT, @DESCRICAO VARCHAR(200) OUTPUT)
AS
BEGIN
	INSERT INTO TB_SERVICO
	VALUES(@ID_TIPOSERVICO, @ID_FUNCIONARIO, @ID_AGENDAMENTO, @DESCRICAO)
END


---- POPULAR SERVICO_PRODUTO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_SERVICO_PRODUTO (@CODIGO_PRODUTO INT, @ID_SERVICO INT OUTPUT)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SP_POPULAR_TIPO_SERVICO(@SERVICO VARCHAR(45), @VALOR NUMERIC(10,2) OUTPUT)
AS
BEGIN
...
---- POPULAR PRODUTO ----
CREATE OR ALTER PROCEDURE SP_POPULAR_PRODUTO (@NOME VARCHAR(45), @QUANTIDADE INT, @VALOR NUMERIC(10,2) OUTPUT)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SP_POPULAR_ESPECIALIZACAO (@NOME VARCHAR(45) OUTPUT)
AS
BEGIN
...
CREATE OR ALTER PROCEDURE SP_POPULAR_FUNCIONARIO_ESPECIALIZACAO (@ID INT, @MATRICULA INT OUTPUT)
AS
BEGIN
...
EXEC SP_POPULAR_SERVICO @ID_TIPOSERVICO=10,
						@ID_FUNCIONARIO=2,
						@ID_AGENDAMENTO=2,
...
ON(A.ID = S.ID_AGENDAMENTO)
INNER JOIN TB_FUNCIONARIO F
ON(F.MATRICULA = S.ID_FUNCIONARIO)
