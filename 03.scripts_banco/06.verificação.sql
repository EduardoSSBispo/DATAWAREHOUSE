...
SELECT F.FAIXA_ETARIA, SUM(S.NUMERO_SERVICO) SERVICOS_ATENDIDOS
...
SELECT F.NM_FUNCIONARIO, SUM(S.NUMERO_SERVICO) SERVICOS_ATENDIDOS
...
SELECT A.CIDADE, A.NM_SALAO, SUM(S.NUMERO_SERVICO) SERVICOS_ATENDIDOS
...
SELECT A.NM_SALAO, AVG(S.VALOR_SERVICO) VALOR_SERVICO
FROM FATO_SERVICO S JOIN DIM_SALAO A
ON(S.ID_SALAO = A.ID_SALAO)
GROUP BY A.NM_SALAO