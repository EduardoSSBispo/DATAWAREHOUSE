...
-------- Carga Agendamento --------
CREATE OR ALTER PROCEDURE SP_OLTP_AGENDAMENTO (@DATA_CARGA DATETIME, @DATA_INICIO DATETIME, @DATA_FIM DATETIME)
AS
BEGIN
	...
	WHERE @DATA_INICIO <= A.DT_AGENDAMENTO AND @DATA_FIM >= A.DT_AGENDAMENTO
END


-------- Carga Serviço --------
CREATE OR ALTER PROCEDURE SP_OLTP_SERVICO (@DATA_CARGA DATETIME, @DATA_INICIO DATETIME, @DATA_FIM DATETIME)
AS
BEGIN
...
EXEC SP_OLTP_AGENDAMENTO '20240101', '20240101', '20240201'

EXEC SP_OLTP_SERVICO '20240101', '20240101', '20240201'
